...
const PricingPacksSection = () => {
  return (
    <section className='py-12 px-1 container mx-auto flex flex-col items-center'>
        <span className='font-bold text-3xl md:text-4xl lg:text-6xl text-[#2D1F67] mb-2 text-center'>
          Choisissez votre pack Studio Créatif avec Liadtech
        </span>
        <span className='md:text-xl lg:text-2xl font-light text-[#2D1F67] mb-8 text-center'>
