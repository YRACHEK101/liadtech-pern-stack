...
const AIChatBotFloatingButton = () => {
  ...
  return (
    <button 
      ...
      type="button" 
      className={cn(
        "group fixed bottom-10 right-10 z-50 flex h-14 w-14 items-center justify-center rounded-2xl bg-purple-600 shadow-lg transition-all duration-200 hover:bg-purple-700 focus:outline-none focus:ring-4 focus:ring-purple-500 focus:ring-opacity-50",
        isOpen && "rotate-45"
      )}
