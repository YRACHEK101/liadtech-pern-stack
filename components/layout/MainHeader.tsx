...
const MainHeader = () => {
    ...
    return (
        <header className="border-b bg-white h-[113px] text-black shadow-md shadow-black/25 z-50 relative">
                ...
                >
                    <div className="p-4 flex flex-col h-full">
                        ...
                        <nav className="flex flex-col space-y-4">
                            ...
                            <Link href="/services" className="text-[#1f1d2c] hover:text-[#673de6] py-2">
                                Services
                            </Link>
                            <Link href="/tarifs" className="text-[#1f1d2c] hover:text-[#673de6] py-2">
                                Tarifs
                            </Link>
                            <Link href="/explorer" className="text-[#1f1d2c] hover:text-[#673de6] py-2">
                                Explorer
                            </Link>
                            <Link href="/support" className="text-[#1f1d2c] hover:text-[#673de6] py-2">
                                Support
                            </Link>
                            <Link href="/about" className="text-[#1f1d2c] hover:text-[#673de6] py-2">
                                L'univers LIADTECH
                            </Link>
                        </nav>
