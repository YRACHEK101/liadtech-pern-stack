        ...
        <div>
            <section className='grid grid-cols-1 md:grid-cols-2 px-4 md:px-16 py-10'>
                <div className='flex flex-col gap-7 pt-10 md:pt-20 pr-0 md:pr-20 z-10'>
                    ...
                    <span className='font-bold text-[#2D1F67] text-lg md:!text-[20px]'>
                ...
                <Image src={"/images/Maintenance, TMA & MCO.svg"} width={0} height={0} className='w-auto origin-top-right scale-100 md:scale-[120%] pt-10 md:pt-20 z-0 h-auto' alt='pic' />
            </section>
            <PricingPacksSection />
            <section className='grid grid-cols-1 md:grid-cols-2 px-4 md:px-16 py-10'>
                ...
                <Image src={"/images/Maintenance, TMA & MCO section1.svg"} width={0} height={0} className='w-auto -mt-10 h-full' alt='pic' />
            </section>
            <section className='grid grid-cols-1 md:grid-cols-2 px-4 md:px-16 gap-10 md:gap-20 py-10'>
                <Image src={"/images/Maintenance, TMA & MCO section 2.svg"} width={0} height={0} className='w-auto origin-top !h-full' alt='pic' />
                <div className='flex flex-col gap-7 pr-0 md:pr-20'>
