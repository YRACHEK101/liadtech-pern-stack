...
import { Check, Bot, Zap, MessageSquare, BrainCircuit, Workflow, Sparkles } from "lucide-react"
import Link from "next/link"
import Image from "next/image"

export default function AutomatisationAgentsIA() {
  return (
    <main className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="bg-gradient-to-b from-[#673de6]/20 via-[#673de6]/10 to-white pt-20 pb-16">
        <div className="container mx-auto text-center">
          <h1 className="text-4xl md:text-6xl font-bold text-[#673de6] mb-4">Automatisation & agents IA</h1>
          <p className="text-xl text-[#1f1d2c] max-w-3xl mx-auto mb-8">
            Optimisez vos processus et améliorez votre relation client grâce à l'intelligence artificielle
          </p>
          <Link href="/contact">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="bg-[#673de6]/10 p-6 rounded-xl">
              <Image
                src="/amethyst-automaton.png"
                alt="Agent IA intelligent"
                width={500}
                height={400}
      ...
      <section className="py-16 bg-[#1f1d2c] text-white">
        <div className="container mx-auto">
          <h2 className="text-3xl font-bold text-center mb-4">Solutions d'automatisation intelligente</h2>
          <p className="text-center text-gray-300 mb-12 max-w-3xl mx-auto">
            Optimisez vos processus métier et améliorez votre relation client grâce à nos solutions d'IA avancées
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="bg-[#2d1f67] border-none shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold mb-3 text-white">Chatbots intelligents</h3>
                <p className="text-gray-300 mb-4">
                  Des assistants virtuels disponibles 24/7 pour répondre aux questions de vos clients et automatiser les
                  tâches répétitives.
                </p>
                <ul className="space-y-2">
                  <li className="flex items-start">
                    ...
                    <span className="ml-3 text-gray-300">Réponses instantanées</span>
                  </li>
                  <li className="flex items-start">
                    <div className="flex-shrink-0 h-5 w-5 bg-[#673de6]/20 rounded-full flex items-center justify-center mt-1">
                      <Check className="h-3 w-3 text-[#673de6]" />
                    </div>
                    <span className="ml-3 text-gray-300">Personnalisation avancée</span>
                  </li>
                  <li className="flex items-start">
                    <div className="flex-shrink-0 h-5 w-5 bg-[#673de6]/20 rounded-full flex items-center justify-center mt-1">
                      <Check className="h-3 w-3 text-[#673de6]" />
                    </div>
                    <span className="ml-3 text-gray-300">Intégration multicanal</span>
                  </li>
                </ul>
              </CardContent>
            </Card>
            ...
            <Card className="bg-[#2d1f67] border-none shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold mb-3 text-white">Automatisation des processus</h3>
                <p className="text-gray-300 mb-4">
                  Optimisez vos flux de travail grâce à l'IA pour gagner en efficacité et réduire les coûts
                  opérationnels.
                </p>
                <ul className="space-y-2">
                  <li className="flex items-start">
                    ...
                    <span className="ml-3 text-gray-300">Workflows intelligents</span>
                  </li>
                  <li className="flex items-start">
                    <div className="flex-shrink-0 h-5 w-5 bg-[#673de6]/20 rounded-full flex items-center justify-center mt-1">
                      <Check className="h-3 w-3 text-[#673de6]" />
                    </div>
                    <span className="ml-3 text-gray-300">Traitement automatisé</span>
                  </li>
                  <li className="flex items-start">
                    <div className="flex-shrink-0 h-5 w-5 bg-[#673de6]/20 rounded-full flex items-center justify-center mt-1">
                      <Check className="h-3 w-3 text-[#673de6]" />
                    </div>
                    <span className="ml-3 text-gray-300">Analyse prédictive</span>
                  </li>
                </ul>
              </CardContent>
            </Card>
            ...
            <Card className="bg-[#2d1f67] border-none shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold mb-3 text-white">Agents IA personnalisés</h3>
                <p className="text-gray-300 mb-4">
                  Des assistants virtuels sur mesure qui s'adaptent à vos besoins spécifiques et à votre secteur
                  d'activité.
                </p>
                <ul className="space-y-2">
                  <li className="flex items-start">
                    ...
                    <span className="ml-3 text-gray-300">Apprentissage continu</span>
                  </li>
                  <li className="flex items-start">
                    <div className="flex-shrink-0 h-5 w-5 bg-[#673de6]/20 rounded-full flex items-center justify-center mt-1">
                      <Check className="h-3 w-3 text-[#673de6]" />
                    </div>
                    <span className="ml-3 text-gray-300">Intégration API</span>
                  </li>
                  <li className="flex items-start">
                    <div className="flex-shrink-0 h-5 w-5 bg-[#673de6]/20 rounded-full flex items-center justify-center mt-1">
                      <Check className="h-3 w-3 text-[#673de6]" />
                    </div>
                    <span className="ml-3 text-gray-300">Analyse de données</span>
                  </li>
                </ul>
              </CardContent>
            </Card>
      ...
      <section className="py-16 bg-[#f8f5ff]">
        <div className="container mx-auto">
          <h2 className="text-3xl font-bold text-center mb-4">Cas d'utilisation</h2>
          <p className="text-center text-gray-600 mb-12 max-w-3xl mx-auto">
            Découvrez comment nos solutions d'automatisation et d'agents IA peuvent transformer votre entreprise
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="bg-white rounded-xl p-8 shadow-md hover:shadow-lg transition-shadow">
              <div className="flex items-start mb-6">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-2">Service client 24/7</h3>
                  <p className="text-gray-600">
                    Offrez un support client disponible à tout moment grâce à nos chatbots intelligents qui répondent
                    instantanément aux questions fréquentes et transfèrent les demandes complexes à vos équipes.
                  </p>
                </div>
              </div>
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <p className="ml-3 text-gray-700">Réduction du temps d'attente pour vos clients</p>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 h-5 w-5 bg-[#673de6] rounded-full flex items-center justify-center mt-1">
                    <Check className="h-3 w-3 text-white" />
                  </div>
                  <p className="ml-3 text-gray-700">Traitement automatisé des demandes simples</p>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 h-5 w-5 bg-[#673de6] rounded-full flex items-center justify-center mt-1">
                    <Check className="h-3 w-3 text-white" />
                  </div>
                  <p className="ml-3 text-gray-700">Amélioration de la satisfaction client</p>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-md hover:shadow-lg transition-shadow">
              <div className="flex items-start mb-6">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-2">Automatisation des processus métier</h3>
                  <p className="text-gray-600">
                    Optimisez vos opérations internes en automatisant les tâches répétitives et chronophages, permettant
                    à vos équipes de se concentrer sur des activités à plus forte valeur ajoutée.
                  </p>
                </div>
              </div>
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <p className="ml-3 text-gray-700">Réduction des erreurs humaines</p>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 h-5 w-5 bg-[#673de6] rounded-full flex items-center justify-center mt-1">
                    <Check className="h-3 w-3 text-white" />
                  </div>
                  <p className="ml-3 text-gray-700">Gain de temps et d'efficacité</p>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 h-5 w-5 bg-[#673de6] rounded-full flex items-center justify-center mt-1">
                    <Check className="h-3 w-3 text-white" />
                  </div>
                  <p className="ml-3 text-gray-700">Optimisation des coûts opérationnels</p>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-md hover:shadow-lg transition-shadow">
              <div className="flex items-start mb-6">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-2">Personnalisation de l'expérience client</h3>
                  <p className="text-gray-600">
                    Offrez une expérience sur mesure à chaque client grâce à nos agents IA qui analysent les
                    comportements et préférences pour proposer des recommandations personnalisées.
                  </p>
                </div>
              </div>
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <p className="ml-3 text-gray-700">Augmentation du taux de conversion</p>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 h-5 w-5 bg-[#673de6] rounded-full flex items-center justify-center mt-1">
                    <Check className="h-3 w-3 text-white" />
                  </div>
                  <p className="ml-3 text-gray-700">Fidélisation client améliorée</p>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 h-5 w-5 bg-[#673de6] rounded-full flex items-center justify-center mt-1">
                    <Check className="h-3 w-3 text-white" />
                  </div>
                  <p className="ml-3 text-gray-700">Expérience utilisateur optimisée</p>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-md hover:shadow-lg transition-shadow">
              <div className="flex items-start mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Anticipez les tendances et comportements grâce à nos solutions d'IA qui analysent vos données pour
                    vous aider à prendre des décisions éclairées et stratégiques.
                  </p>
                </div>
              </div>
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <p className="ml-3 text-gray-700">Identification des opportunités commerciales</p>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 h-5 w-5 bg-[#673de6] rounded-full flex items-center justify-center mt-1">
                    <Check className="h-3 w-3 text-white" />
                  </div>
                  <p className="ml-3 text-gray-700">Optimisation des stocks et ressources</p>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 h-5 w-5 bg-[#673de6] rounded-full flex items-center justify-center mt-1">
                    <Check className="h-3 w-3 text-white" />
                  </div>
                  <p className="ml-3 text-gray-700">Prévention des risques</p>
                </li>
              </ul>
            </div>
          </div>
      ...
      <section className="py-16 bg-[#673de6]">
        <div className="container mx-auto text-center">
          <h2 className="text-3xl font-bold text-white mb-6">Prêt à transformer votre entreprise avec l'IA?</h2>
          <p className="text-white/80 max-w-2xl mx-auto mb-8">
            Contactez-nous dès aujourd'hui pour discuter de vos besoins en automatisation et agents IA, et découvrez
