        ...
        <header className="border-b py-4">
          <div className="container mx-auto flex justify-between items-center">
            <Link href="/" className="flex items-center">
              <span className="text-[#673de6] font-bold text-xl">
                LIAD<span className="text-[#ff41ed]">TECH</span>
              </span>
            </Link>
              ...
              <div className="relative group">
                ...
                <div className="absolute left-0 mt-2 w-[600px] bg-white shadow-xl rounded-md p-6 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50 transform -translate-x-1/2">
                  ...
                  <div className="grid grid-cols-2 gap-8">
                    ...
                    <div className="flex items-start">
                      <div
                        className="flex-shrink-0 h-12 w-12 bg-[#673de6] rounded-full flex items-center
justify-center mr-4"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="flex items-center space-x-4">
              <div className="flex items-center border rounded-md px-2 py-1">
                ...
                <span className="text-sm">FR-EN</span>
              </div>
              <Link href="/login">
                <Button className="bg-[#673de6] hover:bg-[#5f65f4]">Connexion</Button>
              </Link>
            </div>
          </div>
        </header>
        ...
        <footer className="bg-[#1f1d2c] text-white py-12">
          <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="font-bold text-xl mb-4">
                <span className="text-[#673de6]">
                  LIAD<span className="text-[#ff41ed]">TECH</span>
                </span>
              </h3>
              <p className="text-gray-300 mb-4">Transformez vos idées en succès digital</p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link href="/web-marketing" className="text-gray-300 hover:text-white">
                    Web & Marketing
                  </Link>
                </li>
                <li>
                  <Link href="/studio-creatif" className="text-gray-300 hover:text-white">
                    Studio Créatif
                  </Link>
                </li>
                <li>
                  <Link href="/cloud-saas" className="text-gray-300 hover:text-white">
                    Cloud & SaaS
                  </Link>
                </li>
                <li>
                  <Link href="/ia-cybersecurite" className="text-gray-300 hover:text-white">
                    IA & Cybersécurité
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="/tutoriels" className="text-gray-300 hover:text-white">
                    Tutoriels
                  </Link>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="text-gray-300">Email: contact@liadtech.com</li>
                <li className="text-gray-300">Tél: +33 1 23 45 67 89</li>
                <li className="text-gray-300">Adresse: 123 Avenue Tech, 75001 Paris</li>
              </ul>
            </div>
          </div>

          <div className="container mx-auto mt-12 pt-6 border-t border-gray-700">
            <p className="text-gray-400 text-center">© {new Date().getFullYear()} LIADTECH. Tous droits réservés.</p>
          </div>
        </footer>
      </body>
    </html>
