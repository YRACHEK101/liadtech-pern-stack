          ...
          <div className="w-full mx-auto flex justify-between items-center px-4">
            ...
            <nav className="hidden md:flex items-center gap-9 ">
              ...
              <div className=" group">
                ...
                <div className="absolute left-0 mt-16 w-[95vw] bg-white pl-[88px] shadow-md shadow-black/25 rounded-md pb-12 pt-6 pr-10 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50 ">
                  ...
                  <div className="flex justify-center">
                    <hr className="border-[#673DE6] border-2 rounded-full my-8 w-1/2" />
                  </div>
                  <div className="flex flex-col gap-6">
